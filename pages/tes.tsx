    ...
    <div className='flex flex-col items-center justify-center min-h-screen'>
      ...
      <Head>
        <title className='flex justify-between items-center w-full mt-5 pb-7 sm:px-4 px-2'>
          {isHumanToSql
            ? 'Jala - Human to SQL Translator'
            : 'Jala - SQL to Human Translator'}
        </title>
      ...
      <div className='flex flex-col md:flex-row w-full gap-6 bg-[#EEEEEE] dark:text-white dark:bg-black dark:border dark:border-white/20 rounded-2xl '>
        <div className='w-full'>
          ...
          >
            <div className='flex flex-col h-full'>
              ...
              <textarea
                className={`appearance-none border-0 rounded-lg w-full py-20 px-3 bg-custom-gray-bg dark:bg-custom-dark-gray text-gray-700 dark:text-white leading-tight focus:outline-none focus:shadow-outline ${
